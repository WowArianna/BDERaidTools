...
local shutUpBrannToggle = CreateFrame("CheckButton", nil, panel, "InterfaceOptionsCheckButtonTemplate")
shutUpBrannToggle:SetPoint("TOPLEFT", cursorCircleToggle, "BOTTOMLEFT", 0, -5)
shutUpBrannToggle.Text:SetText("Shut Up Brann")
shutUpBrannToggle:SetScript("OnClick", function(self)
    BDE_RAID_TOOLS_DB.SHUTUP_BRANN = self:GetChecked()
...
panel:SetScript("OnShow", function()
    ...
    shutUpBrannToggle:SetChecked(BDE_RAID_TOOLS_DB.SHUTUP_BRANN)
